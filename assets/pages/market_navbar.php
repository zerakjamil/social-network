...
foreach($recent as $fuser){
    ...
    ?>
            ...
            <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0" id="nav">
              <?php if (isMarketRegistered($_SESSION['userdata']['id'])) { ?>
                <li class="nav-item dropdown dropstart">
                    <a class="nav-link" href="#" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="assets/images/market_profile/<?=$market['market_pic']?>" alt="" style="width: 50px;
height: 50px;
object-fit: cover;
border-radius: 50%;
...
">
                    ...
                    <li style="text-align:right;"><a class="dropdown-item" href="?m=<?=$market['user_id']?>"> فرۆشتگاکەم <i class="bi bi-person-circle"></i></a></li>

                        <li style="text-align:right;"><a class="dropdown-item" href="?editmarket"> رێکخستنەکان <i class="uil uil-setting"></i></a></li>
                ...
                <?php }else{ ?>
                  <li class="nav-item">
                    <a class="nav-link text-dark" href="?market_create">
                <button class="icon-btn add-btn">
                <div class="add-icon"></div>
    <div class="btn-txt">درووستکردنی فرۆشگا</div>
</button>
                </a>
                </li>
                  <?php }?>
